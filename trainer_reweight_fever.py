...
def main(argv):
    ...
    # config_path = 
    config_path = "./configs/reweight_config_fever.yaml"
    with open(config_path, "r") as yamlfile:
        config = yaml.load(yamlfile, Loader=yaml.FullLoader)
    
    dataset = {}
    tokenized_datasets = {}
    output_dir = '../models/reweight_fever_claim' 
    ...
    for data_name in ["train_data", "validation_data", "test_data"]:
        print(f'========= {data_name} ===========')
        tokenized_datasets[data_name] = CustomDataset(config, label_maps=label_maps, data_mode=data_name)
