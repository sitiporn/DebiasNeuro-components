...
from my_package.data import ExperimentDataset, Dev, get_conditional_inferences, eval_model_fever, print_config, FeverDatasetClaimOnly
...
def main():
    ...
    experiment_set = FeverDatasetClaimOnly(config,  label_maps=label_maps)                            
    dataloader = DataLoader(experiment_set, batch_size = 32, shuffle = False, num_workers=0)
    # ******************** PATH ********************
    # used to train 
    # LOAD_MODEL_PATH = '../models/baseline_fever/' 
    # LOAD_MODEL_PATH = '../models/pcgu_fever_baseline/' 
    # LOAD_MODEL_PATH = '../models/pcgu_v2_fever_claim_only_reweight/'
    LOAD_MODEL_PATH = '../models/pcgu_v2_fever_claim_only_baseline_ss/' 
    # LOAD_MODEL_PATH = '../models/pcgu_v2_fever_claim_only_poe_/'     
    # LOAD_MODEL_PATH = '../models/pcgu_fever_claim_only_poe/' 
