...
class SequenceClassificationTransformer(BertPreTrainedModel):
    """    
...
from learn_mask.losses import GeneralizedCELoss, ReweightByTeacher, ReweightByTeacherScaled, ProductOfExperts, ProductOfExpertsFromLogits
