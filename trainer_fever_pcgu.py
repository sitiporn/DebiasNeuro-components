...
def main():
    ...
    output_dir = '../models/pcgu_v2_fever_claim_only_baseline_ss/' 
    # output_dir = '../models/pcgu_v2_fever_claim_only_reweight/' 
    # output_dir = '../models/pcgu_v2_fever_claim_only_poe/' 

    # used to train 
    LOAD_MODEL_PATH = '../models/ss_baseline_fever/' 
    # LOAD_MODEL_PATH = '../models/reweight_fever/' 
    # LOAD_MODEL_PATH = '../models/poe_fever/' 
    ...
    advantaged_main, advantaged_bias = get_advantaged_samples(config, model, seed, metric=metric, LOAD_MODEL_PATH=LOAD_MODEL_PATH, is_load_model=True, method_name=method_name, device=DEVICE, collect=True)
    ...
    print(f'Our samples : {our_samples}')
    print(f'Pcgu samples : {pcgu_samples}')
