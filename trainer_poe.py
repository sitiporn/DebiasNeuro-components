...
from custom_model import BertForSequenceClassificationPoE
...
def main():
    ...
    model = BertForSequenceClassificationPoE.from_pretrained(config['tokens']['model_name'], num_labels = len(label_maps.keys()))
